...
function wheelSketch(_p5) {
    ...
    _p5.setup = () => {
        ...
        const descButton = _p5.createButton('?');
        descButton.parent(document.querySelector('.item-image__container'));
        descButton.mousePressed(function () {
            _p5.onHelpClick(data, selectedKey);
        });
